      ...
      showDialog(
          ...
          builder: (_) {
            return DialogLoading(
                title: widget.locale == const Locale('en')
                    ? 'Loading'
                    : 'ກຳລັງໂຫຼດ');
          });
      if (result != null) {
        ...
        if (widget.fromApp == 'G-OFFICE') {
          if (widget.gDomain!.isEmpty) {
            ...
            if (widget.gDomain == 'sbg') {
              ...
              HubDomainModel? hubDomainModel =
                  await hubDomain(context, widget.locale, widget.gDomain, 0);
                          ...
                          onPressed: () async {
                            if (tfDialogLoginPhoneNumber.text == '2077710008') {
                              ...
                              if (widget.fromApp == 'G-OFFICE') {
                                ...
                                _requestOTP("https://laokyc.sbg.la/api/login",
